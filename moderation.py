...
class Moderation(commands.Cog):
    ...
    async def mute(self, ctx, member: discord.Member, *, reason=None):
        guild = ctx.guild
        mutedRole = discord.utils.get(guild.roles, name="🔇║Muted") # You can change the name of the mute role into the role you want in your server
    ...
    async def unmute(self, ctx, member: discord.Member):
        ...
        mutedRole = discord.utils.get(ctx.guild.roles, name="🔇║Muted") # Like above, change the name of the mute role into the one you want
